...
Revision ID: 34bf53fc74f3
Revises: 
Create Date: 2026-05-08 17:33:03.954652
...
def upgrade():
    ...
    sa.CheckConstraint('full_amount >= invested_amount', name='check_full_amount_ge_invested_amount'),
